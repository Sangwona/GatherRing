...
urlpatterns = [
    ...
    path("add_photo/<int:group_id>/", views.add_photo, name="add_group_photo"),
    path("is_member/<int:group_id>/", views.is_member, name="group_is_member"),
    path("get_photos/<int:group_id>", views.get_photos, name="get_group_photos"),
]